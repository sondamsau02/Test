...
<body>
	...
	<div class="row">
		...
		while($row= mysqli_fetch_array($result)){
			...
			<div class="col-md-6" style="text-align: left;">
				...
				<audio controls controlsList="nodownload" ontimeupdate="myAudio(this)" style="width: 250px;">
					   ...
					   <h4> Genre:<?php echo $row["genre_name"]; ?></h4>
					    <textarea cols="40" rows="10" disabled><?php $row["song_lyric"];?></textarea>
			...
			<div class="col-md-6">
				<img src="Images/<?php echo $row['song_image'] ?>" style = "width: 500px;height: 500px;">
			</div> 
		</div>
			<?php
		}
